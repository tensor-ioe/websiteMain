    ...
    return (
        <div className="w-full relative z-20">
            ...
            <div className="w-full mt-[-5px] bg-footerbgcolor">
                <div className="w-full px-4 h-[300px] flex justify-between items-center mx-auto xl:w-width xl:p-0">
                    <div className="flex flex-col items-center gap-[22.5px] xl:mr-16">
                        <h1 className="text-3xl xl:text-[30px] font-extrabold">Follow us</h1>
                        {socialMedia.map((item, index) => {
                            return (
                                <a key={index} className="w-full flex items-center justify-between text-base xl:text-[18px]" target='_blank' rel="noopener noreferrer" href={item[0]}>
                    ...
                    <div className="flex flex-col items-center gap-[15px]">
                        <NavLink to='/' onClick={() => { window.scrollTo(0, 0)}}>
                            <img className="w-[60px] h-[60px]  xl:w-[90px] xl:h-[90px]" src={logo} alt="Tensor" />
                        </NavLink>
                        <a className="flex gap-[10px] text-base xl:text-[18px]" target='_blank' rel="noopener noreferrer" href="https://www.google.com/maps/place/IOE,+Thapathali+Campus/@27.6941071,85.3186142,19z/data=!4m6!3m5!1s0x39eb19ae08c068d9:0x475bed1f66d060c!8m2!3d27.6940347!4d85.3188261!16s%2Fm%2F05zhjq0?entry=ttu&g_ep=EgoyMDI0MDkyNC4wIKXMDSoASAFQAw%3D%3D">
                            <img className="w-4 xl:w-[20px]" src={gps} alt="Location" width='20px' />
                            IOE THAPATHALI
                        </a>
                        <a className="flex gap-[10px] text-base xl:text-[18px]" target='_blank' rel="noopener noreferrer" href="mailto:tensor@tcioe.edu">
                            <img className="w-7 xl:w-[35px]" src={mail} alt="Mail" width='35px' />
                            tensorioe@tcioe.edu
                        </a>
                    </div>
                </div>
